									...
									<div class="row clearfix">
										<div class="col-md-12 column">
											<div class="page-header">
												...
												<span class="W_f14 S_txt1">全部关注</span>
												<em class="attach S_txt1">289</em>
												<em class="attach S_txt2" title=""></em>
												</span>
											</div>
											...
											<div class="col-md-4 column">
												<form role="form">
													<div class="form-group">
														<input type="search" class="form-control" placeholder="搜索" id="serchfriend"  />
														<input type="submit" id="search" value="搜索" class="form-control"/>
													</div>
												</form>
											</div>
										</div>
													...
													<div class="col-md-12 column">
														...
														<div class="col-md-10 column">
															<blockquote>
																<p>
																	周二珂
																</p> <small>主播，歌手 <br><cite>上海</cite></small>
															</blockquote>
														</div>
													</div>
												</div>
													...
													<div class="col-md-12 column">
														...
														<div class="col-md-10 column">
															<blockquote>
																<p>
																	周二珂
																</p> <small>主播，歌手 <cite>上海</cite></small>
															</blockquote>
														</div>
													</div>
												</div>
