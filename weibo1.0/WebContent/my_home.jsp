				...
				<div class="col-md-12 column">
					<div class="row clearfix">
						...
						<div id="fm_main" class="col-md-10 column">
							...
							<!--ct_main div开始-->
							<div id="ct_main" class="row clearfix" style="background-color: rgba(0,0,0,0.1);">
								<!--我的主页左侧内容开始-->
									...
									<div class="panel-group" id="panel-723651">
										...
										<div class="panel panel-default">
											<div class="panel-heading friends_list">
												<a class="panel-title collapsed" data-toggle="collapse" data-parent="#panel-723651" href="#panel-element-287887">朋友</a>
											</div>
											<div id="panel-element-287887" class="panel-collapse collapse">
												<div class="panel-body afriend_bg">
													<a href="#" class="afriend_wrap">
														<img src="img/touxiang.jpg" class="img-circle FL_tx" />
														<span class="FL_name">小飞</span>
													</a>
												</div>
												<div class="panel-body afriend_bg">
													<a href="#" class="afriend_wrap">
														<img src="img/touxiang.jpg" class="img-circle FL_tx" />
														<span class="FL_name">自闯</span>
													</a>
												</div>
												<div class="panel-body afriend_bg">
													<a href="#" class="afriend_wrap">
														<img src="img/touxiang.jpg" class="img-circle FL_tx" />
														<span class="FL_name">帅兵</span>
													</a>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
											<div class="panel-heading friends_list">
												<a class="panel-title collapsed" data-toggle="collapse" data-parent="#panel-723651" href="#list2">同事</a>
											</div>
											<div id="list2" class="panel-collapse collapse">
												<div class="panel-body afriend_bg">
													<a href="#" class="afriend_wrap">
														<img src="img/touxiang.jpg" class="img-circle FL_tx" />
														<span class="FL_name">刘德华</span>
													</a>
												</div>
												<div class="panel-body afriend_bg">
													<a href="#" class="afriend_wrap">
														<img src="img/touxiang.jpg" class="img-circle FL_tx" />
														<span class="FL_name">周润发</span>
													</a>
												</div>
												<div class="panel-body afriend_bg">
													<a href="#" class="afriend_wrap">
														<img src="img/touxiang.jpg" class="img-circle FL_tx" />
														<span class="FL_name">黄渤</span>
													</a>
												</div>
											</div>
										</div>										
									...
									<div class="WB_content S_bg2">
										<div class="content_top row clearfix">
											...
											<div class="col-md-2 column">
												<a href="#">
													<img src="img/touxiang.jpg" class="content_tx img-circle" />
												</a>
											</div>
											<!--微博内容中头像div结束-->
											<!--微博发布的内容div开始-->
											<div class="col-md-10 column">
												<a href="#">
													<h5 style="color: #fff;">cleanEach</h5>
												</a>
