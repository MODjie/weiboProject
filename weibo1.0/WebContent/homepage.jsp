	...
	$(function() {
		...
		$("#forward").click(
				function() {
					...
					location.href = "WeiBoServlet?op=forward&weiboid="
							+ weiboid + "&content=" + content;
				})
	})
				...
				<div class="content">
					...
					<div class="center">
						...
						<div id="myModal" class="modal">
							...
							<!-- 关闭按钮 -->
							<span class="close"><font size="7" color="white">&times;</font>
							</span>
						...
						<iframe id="maincontent" name="maincontent"
							src="WeiBoServlet?op=queryAllWb" frameborder="0" width="100%"
							height="100%"></iframe>
					</div>
					<!--中部发布以及微博显示区域结束-->
					...
					<div class="right">
						...
						<div class="userinfo">
							<c:choose>
								<c:when test="${requestScope.userinfo!=null}">
									<a href="WeiBoServlet?op=queryMyWb"><img
										src="${requestScope.userinfo.TOUXIANG}" alt="140×140"
										class="img-circle touxiang" /></a>
									<div class="username">
								...
								<c:otherwise>
									<a href="WeiBoServlet?op=queryMyWb"><img
										src="upload/touxiang.jpg" alt="140×140"
										class="img-circle touxiang" /></a>
									<div class="username">
						...
						<div class="hotresearch">
							...
							<div class="list">
								<ol>
									<li><a href="">鹿晗关晓彤宣布恋情</a></li>
									<li><a href="">国庆都去哪了</a></li>
									<li><a href="">绝地求生即将禁播20天</a></li>
	...
	<div id="myModal1" class="modal">
		...
		<center>
			<div class="cl share_weibo_wp" style="">
				<div class="cl">
					<h4 class="l">分享到微博</h4>
					<span class="r count_txt">还能输入<strong id="currentLength">120</strong>字
					</span>
				</div>
				<textarea onkeyup="checkLength(this);" id="forwardcontent"
					class="textarea radius inputstyle" name="" cols="" rows=""></textarea>
				<br>
				<button type="button" id="forward" style="margin-top: 15px;"
					class="btn btn-primary text-right">转发</button>
				<button type="button" id="cancle"
					style="margin-top: 15px; margin-left: 100px"
					class="btn btn-primary text-right">取消</button>
			</div>
		</center>
